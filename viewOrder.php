...
<body>
    ...
    ?>
        ...
        <div class="container">
            <div class="table-wrapper" id="empty">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover text-center table-txt responsive">
                        <thead>
                            <tr>
                                <th>Address</th>
                                <th>Phone No</th>
                        ...
                        <td>
                            <form action="partials/_handleOrder.php" method="POST">
                            ...
                            ?>
                                <script>
                                    document.getElementById("empty").innerHTML =
                                        '<div class="col-md-12 my-5"><div class="card"><div class="card-body cart"> <div class="col-sm-12 empty-cart-cls text-center"><img src="partials/uploads/emptycart.jpg" width="200" height="200" class="img-fluid mb-4 mr-3"><h3><strong>You have not ordered any items.</strong></h3><h4>Please order to make me happy :)</h4> <div class="col-md-8 center-button"> <a href="about.php" class="btn btn-primary cart-btn-transform m-5" data-abc="true" >Continue shopping</a> </div></div></div></div></div>';
                                </script>
                            <?php
                            }
                            ?>
        ...
        include 'partials/_handleOrder.php';
        ?>

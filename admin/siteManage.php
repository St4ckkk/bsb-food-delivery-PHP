...
echo '<div class="container-fluid" style="padding-left: 470px;margin-top:98px">
	<div class="card col-lg-6 p-0">
        <div class="title" style="background-color: #242529; color: white;">
            <em><h2 class="text-center" style="margin-top: 11px;">' . htmlspecialchars($systemName) . '</h2></em>
        </div>
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                <div class="form-group">
                    <label for="name" class="control-label">Company Name</label>
                    <input type="text" class="form-control cname" id="name" name="name" value="' . htmlspecialchars($systemName) . '" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="contact1" name="contact1" value="' . htmlspecialchars($contact1) . '" required>
                </div>
                <div class="form-group">
                    <label for="contact" class="control-label">Contact-2(optional)</label>
                    <input type="tel" class="form-control" id="contact2" name="contact2" value="' . htmlspecialchars($contact2) . '" required>
                </div>
                <div class="form-group">

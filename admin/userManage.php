<div class="container-fluid" style="margin-top:98px">
    ...
    <div class="row">
        <div class="card col-lg-12">
            <div class="card-body">
                <table class="table-striped table-bordered col-md-12 text-center table-responsive">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                                    <td>' . $Id . '</td>
                                    <td><img src="/OnlineFoodDelivery/img/profile-' . $Id . '.jpg" alt="image for this user" onError="this.src =\'/OnlineFoodDelivery/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' . $username . '</td>
                                    <td>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                        ...
                        <div class="form-group col-md-4">
                            <img src="/OnlineFoodDelivery/img/profile-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onerror="this.src ='/OnlineFoodDelivery/img/profilePic.png'">
                            <form action="partials/_userManage.php" method="post">
                                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">

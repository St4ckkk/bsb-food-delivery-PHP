            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="contact-box p-4">
                  ...
                  $phone = ''; // Initialize the $phone variable
                  ...
                  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    // Example: Save the contact message to a database
                    $insertSql = "INSERT INTO contact_messages (user_id, email, phone) VALUES ('$userId', '$email', '$phone')";
                  ...
                  <form action="partials/_manageContactUs.php" method="POST">
                    <div class="row">
                      ...
                      <?php if ($loggedin) { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3" style="background-image: linear-gradient(to right, #ff9a00, #ff5252); cursor: pointer;">
                          ...
                          <button type="button" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" style="background-image: linear-gradient(to right, #ff9a00, #ff5252); cursor: pointer;" data-toggle="modal" data-target="#history"><span> HISTORY <i class="ti-arrow-right"></i></span></button>
                        </div>
                      <?php } else { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" style="background-image: linear-gradient(to right, #ff9a00, #ff5252); cursor: pointer;" disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
              ...
              echo '<div class="col-lg-4 bg-image" style="background-image:url(img/boxctc.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/darshankparmar" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-facebook"></i></i></a>
                              <a href="https://youtube.com/" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-instagram"></i></a>
                            </div>
                          </div>
                        </div>';
              ?>
